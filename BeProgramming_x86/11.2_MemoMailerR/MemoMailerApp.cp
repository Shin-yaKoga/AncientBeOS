 ...
 *
 * MemoMailerApp.cp: MemoMailerAppクラスの実装
 *
...
/* アバウトダイアログのメッセージ */
const char	kAboutMsg[] = "MemoMailer\n\n"
	"Copyright " B_UTF8_COPYRIGHT " 1998 Fort Gunnison, Inc.\n"
	"Author: Shin'ya Koga (koga@ftgun.co.jp)";

const char	kMyAppSig[]	= "application/x-vnd.FtGUN-MemoMailer";
...
MemoApp::NewDocument (bool doShow)
{
	...
	if (doShow) {
		...
		newDocWin = new MyMemoWindow(kDefaultDocFrame, docName, DOC_CLOSED);
	} else
		newDocWin = new MyMemoWindow(
